...
//
//class UserObject extends Event
//{
//    /**
//     * @var string unique id in the system
//     */
//    protected $uuid;
//
//    /**
//     * @var string user id in external auth system
//     *
//     * - telephone number
//     * - user id
//     * - email address
...
//
//    /**
//     * @var string name of auth source
//     *
//     *
//     */
//    public $auth_source_name;
//    public $authSource;
//
...
//    public $updated_at;
//
//    public $num_activation_code = 0;
//    public $activation_code_lifetime = 2*24*60*60;
//    public $max_send_activation_code = 4;
//
//    public $lock_time;
//    public $lastlogon;
//    public $logon_count = 0;
//    /**
//     * user roles
//     */
//
...
//    }
//
//    public function init($uid, $authSource = null){
//        $this->extuid = $uid;
...
//    }
//
//    public function __construct($extUid, $authSourceName){
//        $this->extUid = $extUid;
//        //$this->state = AbstractAuth::USER_STATE_INIT;
...
//        if($authSource instanceof AbstractAuth){
//            $this->authSource = $authSource;
//            $this->authSourceName = $authSource->authSourceName;
//        }
//    }
//}


class UserObject implements  StatefulInterface
{
    /**
     *
     */
